...
public class PhraseOMatic {
	...
	public static void main(String[] args) {
		...
		String[] wordListTwo = {"empowered", "sticky", "valude-added", "oriented", "centric", "distributed", "clustered", "branded", "outside-the-box", "positioned", "networked", "focused", "leveraged", "aligned", "targeted", "shared", "cooperative", "accelerated"};
